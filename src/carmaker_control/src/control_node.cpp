...
void ControlNode::controlTimerCallback(const ros::TimerEvent& event)
{
  ...
  const std::size_t nearest_index_tracking =
      findNearestIndex(active_trajectory_, tracking_pose, nearest_index_);
  ...
  const double preview_curvature = computePreviewCurvature(active_trajectory_, nearest_index_, preview_index);
