...
public:
    IcpRegistration(double fitness_threshold, int max_iterations, double vision_base_std, double vision_base_yaw_std, double min_search_radius = 0.5, double max_covariance = 10.0);
